...
VALUES (
           ...
           '2024-01-01',
           5.0,
           NULL -- Imagem em bytes (opcional no insert inicial)
       )
    ON CONFLICT (id) DO NOTHING;

-- Dias de funcionamento (ElementCollection)
INSERT INTO public.restaurante_dias_funcionamento (restaurante_id, dias_funcionamento) VALUES
                                                                                           (2, 'SEXTA'),
                                                                                           (2, 'SABADO'),
                                                                                           (2, 'DOMINGO')
    ON CONFLICT DO NOTHING; -- Nota: ElementCollection geralmente não tem ID exposto, o conflito pode ser na chave composta
...
INSERT INTO public.entregador (
    ...
    placa,
    is_disponivel,
    data_cadastro_entregador,
    avaliacao_media_entregador
)
...
-- ==================================================================================
-- 7. ITENS DO PEDIDO E ADICIONAIS DO ITEM
-- ==================================================================================
...
-- Junção ManyToMany (Sem ID exposto, geralmente)
INSERT INTO public.item_pedido_adicional (item_pedido_id, adicional_id) VALUES (1, 1)
...
VALUES (1, 1, 4, 'PENDENTE', 1, 2, 45, 5.00, NULL, NULL, NULL)
