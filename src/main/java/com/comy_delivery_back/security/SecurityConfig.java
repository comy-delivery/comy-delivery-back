    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity,
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        //Recuperação
                        .requestMatchers("/api/cliente/recuperacao/**").permitAll() // Rotas de recuperação
                        .requestMatchers("/api/restaurante/recuperacao/**").permitAll() // Rotas de recuperação
                        .requestMatchers("/api/entregador/recuperacao/**").permitAll() // Rotas de recuperação
                        .requestMatchers(HttpMethod.POST, "/api/*/recuperar-senha", "/api/*/redefinir-senha").permitAll()
