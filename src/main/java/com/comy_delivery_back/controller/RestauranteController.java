...
public class RestauranteController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Restaurante criado com sucesso",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = RestauranteResponseDTO.class))}),
    ...
    @PostMapping(consumes = MediaType.MULTIPART_FORM_DATA_VALUE) // Adicionado MediaType para clareza
    public ResponseEntity<RestauranteResponseDTO> cadastrarRestaurante(
            ...
            @RequestPart(value = "imagemLogo", required = false) MultipartFile imagem) throws IOException { // required = false para ser opcional
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Restaurante encontrado",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = RestauranteResponseDTO.class))}),
            @ApiResponse(responseCode = "404", description = "ID de restaurante não encontrado",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ProblemDetail.class))})
    })
    @GetMapping("/{id}")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Restaurante encontrado",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = RestauranteResponseDTO.class))}),
            @ApiResponse(responseCode = "404", description = "CNPJ de restaurante não encontrado",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ProblemDetail.class))})
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Restaurante inativado com sucesso (Soft Delete)"),
            @ApiResponse(responseCode = "404", description = "ID de restaurante não encontrado",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ProblemDetail.class))})
    })
    @DeleteMapping("/{id}")
    ...
    @Operation(summary = "Listar todos os restaurantes que estão abertos (isAberto=true)")
    @ApiResponse(responseCode = "200", description = "Lista de restaurantes abertos",
            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = RestauranteResponseDTO.class)))
    @GetMapping("/abertos")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista de produtos",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ProdutoResponseDTO.class))}),
            @ApiResponse(responseCode = "404", description = "ID de restaurante não encontrado",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ProblemDetail.class))})
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Endereço atualizado com sucesso",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = EnderecoResponseDTO.class))}),
            @ApiResponse(responseCode = "404", description = "Restaurante ou Endereço não encontrado",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ProblemDetail.class))}),
            @ApiResponse(responseCode = "400", description = "Endereço não pertence ao restaurante informado",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ProblemDetail.class))})
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "E-mail não fornecido ou inválido",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ProblemDetail.class))})
    })
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(example = "{\"email\": \"restaurante@exemplo.com\"}")))
    ...
    public ResponseEntity<Void> iniciarRecuperacaoSenha(@RequestBody Map<String, String> request) {
        ...
        // Deve retornar 200 OK mesmo que o e-mail não seja encontrado, por segurança
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Token ausente ou nova senha não fornecida",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ProblemDetail.class))}),
            @ApiResponse(responseCode = "404", description = "Token inválido ou expirado",
                    content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ProblemDetail.class))})
    })
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(example = "{\"novaSenha\": \"SenhaSegura123\"}")))
    @PostMapping("/recuperacao/redefinir")
    public ResponseEntity<Void> redefinirSenha(
            @Parameter(in = ParameterIn.QUERY, description = "Token de recuperação enviado por e-mail") @RequestParam String token,
